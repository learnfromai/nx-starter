...
describe('MongooseConnection', () => {
  ...
  describe('connectMongoDB', () => {
    it('should connect to MongoDB using URL from environment', async () => {
    ...
    it('should connect to MongoDB using individual environment variables when URL is not provided', async () => {
      process.env.MONGODB_URL = undefined;
      process.env.MONGODB_HOST = 'testhost';
    ...
    it('should use default values when environment variables are missing', async () => {
      process.env.MONGODB_URL = undefined;
      process.env.MONGODB_HOST = undefined;
      process.env.MONGODB_PORT = undefined;
